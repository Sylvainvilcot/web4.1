<?php
  ...
  mysqli_query($link,"UPDATE dresseurPokemon SET id_pc1 = $pok2_2 WHERE login = '$user'");
  mysqli_query($link,"UPDATE dresseurPokemon SET id_pc2 = $pok3_2 WHERE login = '$user'");
